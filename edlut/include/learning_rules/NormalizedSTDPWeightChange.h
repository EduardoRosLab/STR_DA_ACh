...
#ifndef NORMALIZEDSTDPWEIGHTCHANGE_H_
#define NORMALIZEDSTDPWEIGHTCHANGE_H_
...
/*!
 * \file NormalizedSTDPWeightChange.h
 *
...
/*!
 * \class NormalizedSTDPWeightChange
 *
 * \brief Learning rule.
 *
 ...
 * \date March 2010
 */
class NormalizedSTDPWeightChange: public WithPostSynaptic {
	protected:
		/*!
		* \brief Maximum weight change for LTP
		*/
		float MaxChangePrePos;
		...
		*/
		...
		/*!
		* \brief Decay parameter for eligibility trace
		*/
		float tauEligibility;

		/*!
		* \brief Maximum weight change LTD
		*/
		float MaxChangePosPre;
		...
		/*!
		 * \brief Additive/multiplicative (a=0 add, a=1 mul) parameter
		 */
		float a;
		...
		/*!
		 * \brief Pre-synaptic weight LTD
		 */
		float preLTD;

		/*!
		 * \brief Desired weight sum. Useful when using multiplicative normalizing learning rules
		 */
		float wSum;
	...
	public:
		 ...
		 */
		virtual ~NormalizedSTDPWeightChange();
...
#endif /* NORMALIZEDSTDPWEIGHTCHANGE_H_ */
