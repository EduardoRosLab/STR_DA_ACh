...
#ifndef ASABUKISYNAPSEWEIGHTCHANGE_H_
#define ASABUKISYNAPSEWEIGHTCHANGE_H_
...
/*!
 * \file AsabukiSynapseWeightChange.h
 *
 * \author Álvaro González-Redondo
 * \date June 2022
 *
 * This file declares a class which abstracts an Asabuki et al. (2020) learning
 * rule.
 */
...
/*!
 * \class AsabukiSynapseWeightChange
 *
 * \brief Learning rule.
 *
 * This file declares a class which abstracts an Asabuki et al. (2020) learning
 ...
 * \date June 2022
 */
class AsabukiSynapseWeightChange : public WithPostSynaptic //WithoutPostSynaptic
{
protected:
	/*!
	...
	/*!
	 * \brief Temporal constant of this synapse
	 */
	float tau;
	...
	/*!
	 * \brief Bool variable determining if use the lateral inhibitory learning rule or the feedforward excitatory learning rule
	 */
	int is_lateral;

	/*!
	 * \brief Decay constant for lateral LTP
	 */
	float tau_p;

	/*!
	 * \brief Decay constant for lateral LTD
	 */
	float tau_d;

	/*!
	 * \brief Strength of lateral LTP
	 */
	float Cp;

	/*!
	 * \brief Strength of lateral LTD
	 */
	float Cd;


	/*!
	 * \brief State array of the post-synaptic neuron
	 */
	float *target_state;

	static const int TableSizeExp = 256;
	float exp_x_min = -60.0f;
	float exp_x_max = 0.0f;
...
public:
	 ...
	 */
	virtual ~AsabukiSynapseWeightChange();
	...
	/*!
	 * \brief Set the pointer to the state array of the post-synaptic neuron.
	 *
	 * Set the pointer to the state array of the post-synaptic neuron.
	 *
	 */
	void SetTargetState(float *new_target_state);
...
#endif /* ASABUKISYNAPSEWEIGHTCHANGE_H_ */
