...
class Simulation_API{
	...
	*/
     ...
     */
    std::vector<int> AddNeuronLayer(int num_neurons, std::string model_name, std::map<std::string, boost::any> param_dict, bool log_activity, bool output_activity) ;
    ...
    */
    std::vector<int> AddSynapticLayer(const std::vector<int> & source_neuron, const std::vector<int> & target_neuron, std::map<std::string, boost::any> param_dict) ;
    ...
    */
	void AddExternalCurrentActivity(const std::vector<double> & event_time, const std::vector<long int> & neuron_index, const std::vector<float> & current_value) ;
    ...
    */
    void GetSpikeActivity(std::vector<double> & event_time, std::vector<long int> & neuron_index) ;
	...
	*/
	void AddFileInputSpikeActivityDriver(string FileName) ;
	...
	* \param FileName name of the file where the input activity is stored.
	*/
	void AddFileInputCurrentActivityDriver(string FileName) ;
	...
	* \param FileName name of the file where the input activity is stored.
	*/
	void AddFileOutputSpikeActivityDriver(string FileName) ;
	...
	*/
	void AddFileOutputMonitorDriver(string FileName, bool monitor_state) ;
	...
	*/
	void AddFileOutputWeightDriver(string FileName, float save_period) ;
    ...
    */
    void SetSimulationParameters(std::map<std::string, boost::any> param_dict) ;
    ...
    *
    */
    void RunSimulation(double end_simulation_time) ;
     ...
     */
    int AddLearningRule(std::string model_name, std::map<std::string, boost::any> param_dict) ;
     ...
     */
    std::map<std::string, boost::any> GetLearningRuleDefParams(std::string model_name) ;
     ...
     * \note An exception is raised if a learning rule does not exists with the provided name.
     */
    std::map<std::string, boost::any> GetNeuronModelDefParams(std::string model_name) ;
     ...
     */
    std::map<std::string, boost::any> GetIntegrationMethodDefParams(std::string model_name) ;
     ...
     */
    std::map<std::string, boost::any> GetLearningRuleParams(int lrule_index) ;
     ...
     * \note An exception is raised if the learning rule index does not exist.
     */
    void SetLearningRuleParams(int lrule_index, std::map<std::string, boost::any> newParam) ;
     ...
     */
    float* GetLayerState(int neuron_id, int& neuron_vector_id, int& n_neurons, int& n_states) ;
     ...
     * \note An exception is raised if the neuron index does not exist.
     */
    std::vector<std::map<std::string, boost::any> > GetNeuronParams(std::vector<int> neuron_index) ;
	...
	* \note An exception is raised if the neuron index does not exist.
	*/
	std::vector<std::map<std::string, boost::any> > GetSpecificNeuronParams(std::vector<int> neuron_index) ;
     ...
     */
    void SetSpecificNeuronParams(int neuron_index, std::map<std::string, boost::any> newParam) ;
	...
	*/
	static std::map<std::string, std::string>  GetNeuronModelInfo(string neuronModelName) ;
	...
	* \note An exception is raised if the neuron model does not exist.
	*/
	static void PrintNeuronModelInfo(string neuronModelName) ;
	...
	*/
	static std::map<std::string, std::string> GetVectorizableParameters(std::string ident) ;
	...
	* \throw EDLUTException If the neuron model does not exist with that name.
	*/
	static void PrintVectorizableParameters(std::string ident) ;
};
