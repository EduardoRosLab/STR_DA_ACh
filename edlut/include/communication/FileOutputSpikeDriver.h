...
class FileOutputSpikeDriver: public OutputSpikeDriver {
	...
	public:
		 ...
		 */
		FileOutputSpikeDriver(const char * NewFileName, bool WritePotential) ;
		 ...
		 */
		virtual void WriteSpike(const Spike * NewSpike) ;
		 ...
		 * \throw EDLUTException If something wrong happens in the output process.
		 */		
		virtual void WriteState(float Time, Neuron * Source) ;
