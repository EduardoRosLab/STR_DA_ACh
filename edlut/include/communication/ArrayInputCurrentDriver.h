...
class ArrayInputCurrentDriver: public InputCurrentDriver {
	public:
		 ...
		 */
		void LoadInputs(EventQueue * Queue, Network * Net) ;
		 ...
		 * \throw EDLUTException If something wrong happens in the input process.
		 */
		void LoadInputs(EventQueue * Queue, Network * Net, int NumCurrents, const double * Times, const long int * Cells, const float * Currents) ;
