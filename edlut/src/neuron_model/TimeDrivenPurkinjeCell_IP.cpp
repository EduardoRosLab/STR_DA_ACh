...
std::map<std::string, boost::any> TimeDrivenPurkinjeCell_IP::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void TimeDrivenPurkinjeCell_IP::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * TimeDrivenPurkinjeCell_IP::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription TimeDrivenPurkinjeCell_IP::ParseNeuronModel(std::string FileName) {
	FILE *fh;
