...
std::map<std::string, boost::any> HHTimeDrivenModel::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void HHTimeDrivenModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * HHTimeDrivenModel::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription HHTimeDrivenModel::ParseNeuronModel(std::string FileName) {
	FILE *fh;
