...
std::map<std::string, boost::any> EgidioGranuleCell_TimeDriven::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void EgidioGranuleCell_TimeDriven::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * EgidioGranuleCell_TimeDriven::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription EgidioGranuleCell_TimeDriven::ParseNeuronModel(std::string FileName) {
	FILE *fh;
