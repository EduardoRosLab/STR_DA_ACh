...
void SynchronousTableBasedModel::LoadNeuronModel(string ConfigFile) {
	FILE *fh;
	long Currentline = 0L;
...
void SynchronousTableBasedModel::LoadNeuronModel() {
...
std::map<std::string, boost::any> SynchronousTableBasedModel::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void SynchronousTableBasedModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
ModelDescription SynchronousTableBasedModel::ParseNeuronModel(std::string FileName) {
