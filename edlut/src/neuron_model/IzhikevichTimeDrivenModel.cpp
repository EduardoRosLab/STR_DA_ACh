...
std::map<std::string, boost::any> IzhikevichTimeDrivenModel::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void IzhikevichTimeDrivenModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * IzhikevichTimeDrivenModel::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription IzhikevichTimeDrivenModel::ParseNeuronModel(std::string FileName) {
	FILE *fh;
