...
std::map<std::string, boost::any> TimeDrivenPurkinjeCell::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void TimeDrivenPurkinjeCell::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * TimeDrivenPurkinjeCell::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription TimeDrivenPurkinjeCell::ParseNeuronModel(std::string FileName) {
	FILE *fh;
