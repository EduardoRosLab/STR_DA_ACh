...
std::map<std::string, boost::any> PoissonGeneratorDeviceVector::GetSpecificNeuronParameters(int index) const {
...
void PoissonGeneratorDeviceVector::SetParameters(std::map<std::string, boost::any> param_map) {
...
void PoissonGeneratorDeviceVector::SetSpecificNeuronParameters(int index, std::map<std::string, boost::any> param_map) {
...
ModelDescription PoissonGeneratorDeviceVector::ParseNeuronModel(std::string FileName) {
	FILE *fh;
