...
void NeuronModelTable::GenerateVirtualCoordinates() {
...
void NeuronModelTable::LoadTable(FILE *fd) {
	void **elems;
...
void NeuronModelTable::LoadTableDescription(string ConfigFile, FILE *fh, long & Currentline) {
	int previntdim;
	int nv;
