...
std::map<std::string, boost::any> LIFTimeDrivenModel_IS::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void LIFTimeDrivenModel_IS::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * LIFTimeDrivenModel_IS::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription LIFTimeDrivenModel_IS::ParseNeuronModel(std::string FileName) {
	FILE *fh;
