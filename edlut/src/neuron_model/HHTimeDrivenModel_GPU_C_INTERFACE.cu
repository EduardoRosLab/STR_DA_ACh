...
std::map<std::string, boost::any> HHTimeDrivenModel_GPU_C_INTERFACE::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void HHTimeDrivenModel_GPU_C_INTERFACE::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod_GPU_C_INTERFACE * HHTimeDrivenModel_GPU_C_INTERFACE::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription HHTimeDrivenModel_GPU_C_INTERFACE::ParseNeuronModel(std::string FileName) {
	FILE *fh;
