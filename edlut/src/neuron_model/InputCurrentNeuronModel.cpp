...
std::map<std::string, boost::any> InputCurrentNeuronModel::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void InputCurrentNeuronModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
ModelDescription InputCurrentNeuronModel::ParseNeuronModel(std::string FileName) {
