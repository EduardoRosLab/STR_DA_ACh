...
std::map<std::string, boost::any> AdExTimeDrivenModel::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void AdExTimeDrivenModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * AdExTimeDrivenModel::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription AdExTimeDrivenModel::ParseNeuronModel(std::string FileName) {
	FILE *fh;
