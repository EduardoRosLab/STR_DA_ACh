...
std::map<std::string, boost::any> TimeDrivenInferiorOliveCell::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void TimeDrivenInferiorOliveCell::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * TimeDrivenInferiorOliveCell::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription TimeDrivenInferiorOliveCell::ParseNeuronModel(std::string FileName) {
	FILE *fh;
