...
std::vector<std::string> NeuronModelFactory::GetAvailableNeuronModels(){
	...
	availableNeuronModels.push_back(LIFTimeDrivenModel_DA::GetName());
  	availableNeuronModels.push_back(AsabukiNeuron::GetName());
...
void NeuronModelFactory::InitializeNeuronModelFactory(){
	if (NeuronModelFactory::NeuronModelMap.empty()){
		...
		NeuronModelFactory::NeuronModelMap[AsabukiNeuron::GetName()] =
			NeuronModelFactory::NeuronModelClass(
				AsabukiNeuron::ParseNeuronModel,
				AsabukiNeuron::CreateNeuronModel,
				AsabukiNeuron::GetDefaultParameters,
				AsabukiNeuron::GetNeuronModelInfo);
...
NeuronModel * NeuronModelFactory::CreateNeuronModel(ModelDescription nmodelDescription) {
...
ModelDescription NeuronModelFactory::ParseNeuronModel(std::string ident, std::string ident_param)  {
    NeuronModelFactory::InitializeNeuronModelFactory();
    // Find the rule description name in the learning rule map
    std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
...
std::map<std::string, boost::any> NeuronModelFactory::GetDefaultParameters(std::string ident) {
    NeuronModelFactory::InitializeNeuronModelFactory();
    // Find the rule description name in the learning rule map
    std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
            NeuronModelFactory::NeuronModelMap.find(ident);
...
std::map<std::string, std::string> NeuronModelFactory::GetNeuronModelInfo(std::string ident) {
	NeuronModelFactory::InitializeNeuronModelFactory();
	// Find the rule description name in the learning rule map
	std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
		NeuronModelFactory::NeuronModelMap.find(ident);
...
void NeuronModelFactory::PrintNeuronModelInfo(std::string ident) {
	NeuronModelFactory::InitializeNeuronModelFactory();
	// Find the rule description name in the learning rule map
	std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
		NeuronModelFactory::NeuronModelMap.find(ident);
...
std::map<std::string, std::string> NeuronModelFactory::GetVectorizableParameters(std::string ident) {
	NeuronModelFactory::InitializeNeuronModelFactory();
	// Find the rule description name in the learning rule map
	std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
		NeuronModelFactory::NeuronModelMap.find(ident);
...
void NeuronModelFactory::PrintVectorizableParameters(std::string ident) {
	NeuronModelFactory::InitializeNeuronModelFactory();
	// Find the rule description name in the learning rule map
	std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
		NeuronModelFactory::NeuronModelMap.find(ident);
