...
void CompressSynchronousTableBasedModel::LoadNeuronModel(string ConfigFile) {
	FILE *fh;
	long Currentline = 0L;
...
void CompressSynchronousTableBasedModel::LoadNeuronModel() {
...
std::map<std::string, boost::any> CompressSynchronousTableBasedModel::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void CompressSynchronousTableBasedModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
ModelDescription CompressSynchronousTableBasedModel::ParseNeuronModel(std::string FileName) {
