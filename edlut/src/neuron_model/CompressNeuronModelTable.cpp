...
void CompressNeuronModelTable::GenerateVirtualCoordinates() {
...
void CompressNeuronModelTable::LoadTable(FILE *fd) {
	void **elems;
...
void CompressNeuronModelTable::LoadTableDescription(string ConfigFile, FILE *fh, long & Currentline) {
	int previntdim;
	int nv;
