...
std::map<std::string, boost::any> InputSpikeNeuronModel::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void InputSpikeNeuronModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
ModelDescription InputSpikeNeuronModel::ParseNeuronModel(std::string FileName) {
