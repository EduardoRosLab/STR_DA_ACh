...
std::map<std::string, boost::any> AdExTimeDrivenModelVector::GetSpecificNeuronParameters(int index) const {
...
void AdExTimeDrivenModelVector::SetParameters(std::map<std::string, boost::any> param_map) {
...
void AdExTimeDrivenModelVector::SetSpecificNeuronParameters(int index, std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * AdExTimeDrivenModelVector::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription AdExTimeDrivenModelVector::ParseNeuronModel(std::string FileName) {
	FILE *fh;
