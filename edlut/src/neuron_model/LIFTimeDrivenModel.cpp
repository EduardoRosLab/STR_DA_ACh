...
std::map<std::string, boost::any> LIFTimeDrivenModel::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void LIFTimeDrivenModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
IntegrationMethod * LIFTimeDrivenModel::CreateIntegrationMethod(ModelDescription imethodDescription) {
...
ModelDescription LIFTimeDrivenModel::ParseNeuronModel(std::string FileName) {
	FILE *fh;
