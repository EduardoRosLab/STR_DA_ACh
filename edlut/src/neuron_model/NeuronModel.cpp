...
void NeuronModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
void NeuronModel::SetSpecificNeuronParameters(int index, std::map<std::string, boost::any> param_map) {
	if (!param_map.empty()){
		cout << "Parameters ";
