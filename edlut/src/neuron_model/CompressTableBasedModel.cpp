...
void CompressTableBasedModel::LoadNeuronModel(string ConfigFile) {
	FILE *fh;
	long Currentline = 0L;
...
void CompressTableBasedModel::LoadTables(string TableFile) {
	FILE *fd;
	unsigned int i;
...
void CompressTableBasedModel::LoadNeuronModel() {
...
std::map<std::string, boost::any> CompressTableBasedModel::GetSpecificNeuronParameters(int index) const {
	return GetParameters();
}

void CompressTableBasedModel::SetParameters(std::map<std::string, boost::any> param_map) {
...
ModelDescription CompressTableBasedModel::ParseNeuronModel(std::string FileName) {
