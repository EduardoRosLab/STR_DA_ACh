...
void ParamReader::ParseArguments(int Number, char ** Arguments)  {
...
ParamReader::ParamReader(int ArgNumber, char ** Arg)  :SimulationTime(-1.0), NetworkFile(NULL), WeightsFile(NULL), WeightTime(0.0), NetworkInfo(false),
...
Simulation * ParamReader::CreateAndInitializeSimulation() {
