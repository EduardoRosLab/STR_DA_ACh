...
FileOutputWeightDriver::FileOutputWeightDriver(const char * NewFileName) : FileName(NewFileName){
}
		
FileOutputWeightDriver::~FileOutputWeightDriver(){
}

void FileOutputWeightDriver::WriteWeights(Network * Net, float SimulationTime) {
...
void FileOutputWeightDriver::WriteWeights(Network * Net) {
