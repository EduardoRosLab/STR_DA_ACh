...
FileOutputSpikeDriver::FileOutputSpikeDriver(const char * NewFileName, bool WritePotential) : FileName(NewFileName){
...
void FileOutputSpikeDriver::WriteSpike(const Spike * NewSpike) {
...
void FileOutputSpikeDriver::WriteState(float Time, Neuron * Source) {
	#pragma omp critical (FileOutputSpikeDriver)
	{
