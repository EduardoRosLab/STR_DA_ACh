...
void ArrayInputSpikeDriver::LoadInputs(EventQueue * Queue, Network * Net) {
	return;
}

void ArrayInputSpikeDriver::LoadInputs(EventQueue * Queue, Network * Net, int NumSpikes, const double * Times, const long int * Cells) {
	if (NumSpikes>0){
