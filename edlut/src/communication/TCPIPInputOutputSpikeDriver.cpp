...
void TCPIPInputOutputSpikeDriver::LoadInputs(EventQueue * Queue, Network * Net) {
...
void TCPIPInputOutputSpikeDriver::WriteSpike(const Spike * NewSpike) {
...
void TCPIPInputOutputSpikeDriver::WriteState(float Time, Neuron * Source) {
	return;	
}
...
void TCPIPInputOutputSpikeDriver::FlushBuffers() {
