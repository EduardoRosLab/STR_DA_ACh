...
void TCPIPOutputSpikeDriver::WriteSpike(const Spike * NewSpike) {
...
void TCPIPOutputSpikeDriver::WriteState(float Time, Neuron * Source) {
	return;	
}
...
void TCPIPOutputSpikeDriver::FlushBuffers() {
