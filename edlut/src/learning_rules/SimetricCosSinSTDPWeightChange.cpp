...
ModelDescription SimetricCosSinSTDPWeightChange::ParseLearningRule(FILE * fh)  {
...
void SimetricCosSinSTDPWeightChange::SetParameters(std::map<std::string, boost::any> param_map) {
