...
ModelDescription SimetricCosSTDPWeightChange::ParseLearningRule(FILE * fh)  {
...
void SimetricCosSTDPWeightChange::SetParameters(std::map<std::string, boost::any> param_map) {
