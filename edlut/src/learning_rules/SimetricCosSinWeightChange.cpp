...
ModelDescription SimetricCosSinWeightChange::ParseLearningRule(FILE * fh)  {
...
void SimetricCosSinWeightChange::SetParameters(std::map<std::string, boost::any> param_map) {
