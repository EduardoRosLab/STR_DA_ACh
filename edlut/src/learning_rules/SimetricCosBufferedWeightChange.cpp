...
ModelDescription SimetricCosBufferedWeightChange::ParseLearningRule(FILE * fh)  {
...
void SimetricCosBufferedWeightChange::SetParameters(std::map<std::string, boost::any> param_map) {
