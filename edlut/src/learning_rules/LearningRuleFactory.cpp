...
#include "learning_rules/ESTDEWeightChange.h"
...
#include "learning_rules/NormalizedSTDPWeightChange.h"
#include "learning_rules/AsabukiSynapseWeightChange.h"
...
std::vector<std::string> LearningRuleFactory::GetAvailableLearningRules(){
  ...
  availableLearningRules.push_back(ESTDEWeightChange::GetName());
	...
	availableLearningRules.push_back(STDPWeightChange::GetName());
        	availableLearningRules.push_back(NormalizedSTDPWeightChange::GetName());
                availableLearningRules.push_back(AsabukiSynapseWeightChange::GetName());
...
void LearningRuleFactory::InitializeLearningRuleFactory(){
    if (LearningRuleFactory::LearningRuleMap.empty()){
        ...
        LearningRuleFactory::LearningRuleMap[ESTDEWeightChange::GetName()] =
              	LearningRuleFactory::LearningRuleClass(
                    		ESTDEWeightChange::ParseLearningRule,
                    		ESTDEWeightChange::CreateLearningRule,
                    		ESTDEWeightChange::GetDefaultParameters);
        ...
        LearningRuleFactory::LearningRuleMap[NormalizedSTDPWeightChange::GetName()] =
                LearningRuleFactory::LearningRuleClass(
                        NormalizedSTDPWeightChange::ParseLearningRule,
                        NormalizedSTDPWeightChange::CreateLearningRule,
                        NormalizedSTDPWeightChange::GetDefaultParameters);

        LearningRuleFactory::LearningRuleMap[AsabukiSynapseWeightChange::GetName()] =
                LearningRuleFactory::LearningRuleClass(
                        AsabukiSynapseWeightChange::ParseLearningRule,
                        AsabukiSynapseWeightChange::CreateLearningRule,
                        AsabukiSynapseWeightChange::GetDefaultParameters);
